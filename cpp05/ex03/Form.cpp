...
Form::Form() : _name(""), _target(""), _isSigned(0), _gradeToSign(150), _gradeToExcute(150)
{
	std::cout << "Form Default Constructor called." << std::endl;
}

Form::Form( std::string name, std::string target, int gradeToSign, int gradeToExcute ) : _name(name), _target(target), _isSigned(false), _gradeToSign(gradeToSign), _gradeToExcute(gradeToExcute)
{
	std::cout << "Form Name + Target + Grade Constructor called." << std::endl;
